...
The Developers of the game are: Victor Gasior, Blade Johnson, Andrew Newbill, and Lucky Woods. We have put our focus into making sure the game runs as smoothly as possible and put in as much as possible to make it like many classical arena shooters of the past. The game is separated into three important categories of focus: core gameplay, networking, and User Interface design along with customizable settings. Gameplay will go over core concepts of the game such as weapons, movement, and map design. Networking will go over how the players will be able to play together and how they interact with each other. User Interface will go over the interface the players will be seeing constantly along with settings for a player to have their own preferred play style.
