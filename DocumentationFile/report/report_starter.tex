...
The Developers of the game are: Victor Gasior, Blade Johnson, Andrew Newbill, and Lucky Woods. The primary goal of the the project is to not only be functionally sound with minimal issues, but to feel enjoyable to play. This led to the game being separated into three important categories of focus: core gameplay, networking, and the user experience. Gameplay will go over core concepts of the game such as weapons, movement, and map design. Networking will go over how the players will be able to play together and how said players will interact. User experience will go over the interface the players will be seeing constantly along with settings for a player to have their own preferred play style.
