...
\frameT{Weapon Models}{
\begin{center}
	\includegraphics[height=.2\linewidth]{figures/ar.png}
	\includegraphics[height=.2\linewidth]{figures/diskgun.png}
 \end{center}
 \begin{center}
	\includegraphics[height=.2\linewidth]{figures/Sniper.png}
 \includegraphics[height=.2\linewidth]{figures/pistol.png}
 \end{center}
} 
...
\includegraphics[height=.5\linewidth]{figures/TestDemoGame.png}
}
...
\frameT{Difficulties}{
  ...
  \begin{itemize}
      ...
      \item Designing issues on the Rat Model
  \end{itemize}
}
...
\frameT{Future Goals}{
  ...
  \begin{itemize}
	  ...
	  \item Adding textures to Rat model and trying to smooth the design.
      \item General clean up of debugging and quality of life improvements.
      \item Finishing the second map.
  \end{itemize}
}
%\Test Online Video!!!!
%\frameT{Demo}{
